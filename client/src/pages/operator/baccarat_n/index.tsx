      ...
      <div className="grid grid-cols-3">
        <div className="col-span-2">
          <div className="bg-yellow-100 text-black flex justify-between items-center p-4">
            <div className="text-8xl font-bold bg-blue-600 text-amber-300 px-6 my-0 rounded-lg">
              {desk?.name}
            </div>
        ...
        <div className="bg-yellow-100 w-full h-full p-5">
          ...
          <div className="grid grid-cols-5 gap-1 w-full py-10 px-2">
              ...
              return (
                <Button
                  ...
                  className={cn(
                    ...
                    firstKey === "supertwoSix" && "bg-red-600 hover:bg-red-500",
